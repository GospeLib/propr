...
export { claimTerminalTransition, terminalTransitionId, durableOperationIdentity, durableTerminalTransitionRecorded, TERMINAL_OPERATION_IDENTITY_MISSING } from './utils/terminalTransitionClaim.js';
export { publishCompletedWithDurableExecutionEvidence, carriesTerminalExecutionEvidence, certifyDurableCompletion, isDurableCompletionAbsent, COMPLETION_WITHOUT_EXECUTION_EVIDENCE, COMPLETION_HISTORY_NOT_DURABLE, COMPLETION_PERSISTENCE_FAILED_SUFFIX, DURABLE_COMPLETION_ABSENT } from './utils/durableCompletionBarrier.js';
export type { DurableCompletionOptions, DurableCompletionResult } from './utils/durableCompletionBarrier.js';
export { acquireExecutionLease, renewExecutionLease, settleExecutionLease, releaseExecutionLease, startExecutionLeaseRenewal, recordExecutorStopProof, recordVerifiedExecutorStop, reconcileProviderInvocationSpend, markProviderInvocationStarted, retainLeaseForReconciliation, lapsedExecutionLeases, databaseNow, PROVIDER_SPEND_RECONCILED_STATE, EXECUTION_LEASE_HELD, EXECUTION_LEASE_SETTLED, EXECUTION_LEASE_UNRECONCILED, EXECUTION_LEASE_TTL_MS, EXECUTION_LEASE_RENEWAL_INTERVAL_MS, MINIMUM_STOP_PROOF_LENGTH } from './utils/executionLease.js';
export type { ExecutionLeaseOutcome, ExecutionLeaseRequest, HeldExecutionLease, ExecutorStopOutcome, ExecutorStopRefusal, LapsedExecutionLease, StopProofRecording, ProviderSpendDisposition } from './utils/executionLease.js';
